...
include_once('layout/header.php'); // Include your header file
include_once('layout/navigation.php'); // Include your navigation file
include_once('admin/dbconnect.php');

// Check if a booking ID is passed in the URL 
if (isset($_GET['bookingId'])) { // Updated to 'bookingId'
    $bookingId = $_GET['bookingId']; // Updated to 'bookingId'
...
?>
        ...
        <main id="main" class="scrolled-offset">
            <!-- Add your HTML structure to display booking details here -->
            <section id="booking-details" class="booking-details">
                ...
                <!-- Button to download pdf or to print -->
...
include_once('layout/footer.php'); // Include your footer file
?>
